        ...
        <div className="mt-3">
          {leaders.map((operator, index) => (
            <button
              ...
              className="flex h-[52px] w-full items-center gap-4 border-b border-[var(--dashboard-rule)] px-0.5 text-left transition-colors hover:bg-[var(--dashboard-row-hover)]"
            >
              ...
              <span className="h-1.5 w-[150px] flex-none overflow-hidden rounded-full bg-[var(--dashboard-track-soft)] max-sm:hidden">
                <span
              ...
              <span className="w-[78px] flex-none text-right text-sm text-foreground max-sm:w-[64px]">
